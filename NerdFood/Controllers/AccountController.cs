...
namespace NerdFood.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        {
            UserManager.UserValidator = new CustomUserValidator<AppIdentityUser>(UserManager);
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var userValidationResult = await UserManager.UserValidator.ValidateAsync(user);
                ...
                {
                    AddErrors(userValidationResult);
                }
            }
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            else
            {
                ...
                return View("ExternalLoginConfirmation", new ExternalLoginConfirmationViewModel { UserName = email, Name = firstName, LastName = lastName });
            }
        }
        ...
        private async Task SignInAsync(AppIdentityUser user, bool isPersistent)
        {
            AuthenticationManager.SignOut(DefaultAuthenticationTypes.ExternalCookie);
            var identity = await UserManager.CreateIdentityAsync(user, DefaultAuthenticationTypes.ApplicationCookie);

            // Claims management for user information
